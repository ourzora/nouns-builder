...
export type AuctionFragment = { __typename?: 'NounsBuilderAuction', auction?: string | null, collectionAddress: string };

export type DaoFragment = { __typename?: 'NounsDao', name?: string | null, collectionAddress: string, auctionAddress?: string | null };

export type ImageMediaEncodingFragment = { __typename?: 'ImageEncodingTypes', original: string, thumbnail?: string | null };

export type ProposalFragment = { __typename: 'NounsProposal', abstainVotes: number, againstVotes: number, auction: string, calldatas: Array<string>, collectionAddress: string, description: string, descriptionHash: string, executableFrom?: number | null, expiresAt?: number | null, forVotes: number, governor: string, manager: string, metadata: string, proposalId: string, proposalNumber: number, proposalThreshold: number, proposer: string, quorumVotes: number, status: NounsProposalStatus, targets: Array<string>, timeCreated: number, title: string, treasury: string, values: Array<string>, voteEnd: number, voteStart: number };

export type ProposalVoteFragment = { __typename?: 'NounsProposalVote', voter: string, support: Support, weight: number, reason: string };

export type TokenFragment = { __typename?: 'Token', tokenId: string, name?: string | null, description?: string | null, owner?: string | null, image?: { __typename?: 'TokenContentMedia', url?: string | null, mediaEncoding?: { __typename: 'AudioEncodingTypes' } | { __typename: 'ImageEncodingTypes', original: string, thumbnail?: string | null } | { __typename: 'UnsupportedEncodingTypes' } | { __typename: 'VideoEncodingTypes' } | null } | null, mintInfo?: { __typename?: 'MintInfo', mintContext: { __typename?: 'TransactionInfo', blockTimestamp: any } } | null };

export type VoteFragment = { __typename?: 'NounsBuilderGovernorVoteCastEventProperties', proposalId: string, voter: string, reason: string, support: string, weight: string };
...
export type ActiveAuctionsQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsMarkets: { __typename?: 'NounsBuilderAuctionConnection', nodes: Array<{ __typename?: 'NounsBuilderAuction', auction?: string | null, collectionAddress: string }> } } };
...
export type DaoInfoQuery = { __typename?: 'RootQuery', aggregateStat: { __typename?: 'AggregateStat', ownerCount: number }, nouns: { __typename?: 'Nouns', nounsDaos: { __typename?: 'NounsDaoConnection', nodes: Array<{ __typename?: 'NounsDao', totalSupply?: number | null }> } } };
...
export type DaosQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsDaos: { __typename?: 'NounsDaoConnection', nodes: Array<{ __typename?: 'NounsDao', name?: string | null, collectionAddress: string, auctionAddress?: string | null }> } } };
...
export type ExploreDaosPageQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsMarkets: { __typename?: 'NounsBuilderAuctionConnection', nodes: Array<{ __typename?: 'NounsBuilderAuction', collectionAddress: string, tokenId: string, endTime: string, highestBidder?: string | null, highestBidPrice?: { __typename?: 'PriceAtTime', chainTokenPrice?: { __typename?: 'CurrencyAmount', decimal: number } | null } | null }>, pageInfo: { __typename?: 'PageInfo', limit: number, hasNextPage: boolean, endCursor?: string | null } } } };
...
export type ExploreTokensQuery = { __typename?: 'RootQuery', tokens: { __typename?: 'TokenWithMarketsSummaryConnection', nodes: Array<{ __typename?: 'TokenWithMarketsSummary', token: { __typename?: 'Token', collectionAddress: string, collectionName?: string | null, name?: string | null, image?: { __typename?: 'TokenContentMedia', url?: string | null } | null } }>, pageInfo: { __typename?: 'PageInfo', limit: number, hasNextPage: boolean, endCursor?: string | null } } };
...
export type MyDaosPageQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsDaos: { __typename?: 'NounsDaoConnection', nodes: Array<{ __typename?: 'NounsDao', collectionAddress: string }>, pageInfo: { __typename?: 'PageInfo', limit: number, hasNextPage: boolean, endCursor?: string | null } } } };
...
export type ProposalQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsProposal?: { __typename: 'NounsProposal', abstainVotes: number, againstVotes: number, auction: string, calldatas: Array<string>, collectionAddress: string, description: string, descriptionHash: string, executableFrom?: number | null, expiresAt?: number | null, forVotes: number, governor: string, manager: string, metadata: string, proposalId: string, proposalNumber: number, proposalThreshold: number, proposer: string, quorumVotes: number, status: NounsProposalStatus, targets: Array<string>, timeCreated: number, title: string, treasury: string, values: Array<string>, voteEnd: number, voteStart: number, transactionInfo: { __typename?: 'TransactionInfo', blockNumber: number, transactionHash?: string | null }, votes: Array<{ __typename?: 'NounsProposalVote', voter: string, support: Support, weight: number, reason: string }> } | null } };
...
export type ProposalsQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsProposals: { __typename?: 'NounsProposalConnection', nodes: Array<{ __typename: 'NounsProposal', abstainVotes: number, againstVotes: number, auction: string, calldatas: Array<string>, collectionAddress: string, description: string, descriptionHash: string, executableFrom?: number | null, expiresAt?: number | null, forVotes: number, governor: string, manager: string, metadata: string, proposalId: string, proposalNumber: number, proposalThreshold: number, proposer: string, quorumVotes: number, status: NounsProposalStatus, targets: Array<string>, timeCreated: number, title: string, treasury: string, values: Array<string>, voteEnd: number, voteStart: number, transactionInfo: { __typename?: 'TransactionInfo', blockNumber: number, transactionHash?: string | null } }>, pageInfo: { __typename?: 'PageInfo', limit: number, hasNextPage: boolean, endCursor?: string | null } } } };
...
export type ProposalsWithCalldataQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsProposals: { __typename?: 'NounsProposalConnection', nodes: Array<{ __typename?: 'NounsProposal', proposalId: string, proposalNumber: number, status: NounsProposalStatus, calldatas: Array<string>, targets: Array<string>, values: Array<string> }> } } };
...
export type TokenQuery = { __typename?: 'RootQuery', token?: { __typename?: 'TokenWithFullMarketHistory', token: { __typename?: 'Token', tokenId: string, name?: string | null, description?: string | null, owner?: string | null, image?: { __typename?: 'TokenContentMedia', url?: string | null, mediaEncoding?: { __typename: 'AudioEncodingTypes' } | { __typename: 'ImageEncodingTypes', original: string, thumbnail?: string | null } | { __typename: 'UnsupportedEncodingTypes' } | { __typename: 'VideoEncodingTypes' } | null } | null, mintInfo?: { __typename?: 'MintInfo', mintContext: { __typename?: 'TransactionInfo', blockTimestamp: any } } | null } } | null };
...
export type TokenOwnersQuery = { __typename?: 'RootQuery', aggregateStat: { __typename?: 'AggregateStat', ownersByCount: { __typename?: 'OwnerCountConnection', nodes: Array<{ __typename?: 'OwnerCount', owner: string, count: number }> } } };
...
export type TokenWinnerQuery = { __typename?: 'RootQuery', nouns: { __typename?: 'Nouns', nounsMarkets: { __typename?: 'NounsBuilderAuctionConnection', nodes: Array<{ __typename?: 'NounsBuilderAuction', highestBidder?: string | null, highestBidPrice?: { __typename?: 'PriceAtTime', chainTokenPrice?: { __typename?: 'CurrencyAmount', decimal: number } | null } | null }> } } };
...
export type TokensQuery = { __typename?: 'RootQuery', tokens: { __typename?: 'TokenWithMarketsSummaryConnection', nodes: Array<{ __typename?: 'TokenWithMarketsSummary', token: { __typename?: 'Token', name?: string | null, image?: { __typename?: 'TokenContentMedia', url?: string | null, mediaEncoding?: { __typename: 'AudioEncodingTypes' } | { __typename: 'ImageEncodingTypes', original: string, thumbnail?: string | null } | { __typename: 'UnsupportedEncodingTypes' } | { __typename: 'VideoEncodingTypes' } | null } | null } }> } };
...
export const ExploreDaosPageDocument = gql`
    query exploreDaosPage($chain: Chain!, $after: String, $sortKey: MarketSortKey!, $collectionAddresses: [String!]) {
  nouns {
    nounsMarkets(
      networks: {network: ETHEREUM, chain: $chain}
      filter: {nounsMarketType: NOUNS_BUILDER_AUCTION, status: ACTIVE}
...
export const NftCountDocument = gql`
    query nftCount($collectionAddress: [String!], $ownerAddress: [String!], $chain: Chain!) {
  aggregateStat {
    nftCount(
...
export const TokensDocument = gql`
    query tokens($chain: Chain!, $pagination: PaginationInput = null, $filter: TokensQueryFilter = null, $where: TokensQueryInput = null, $sort: TokenSortInput = null) {
  tokens(
    pagination: $pagination
    networks: {network: ETHEREUM, chain: $chain}
    filter: $filter
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    daos(variables: DaosQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<DaosQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<DaosQuery>(DaosDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'daos', 'query');
    },
    ...
    exploreTokens(variables: ExploreTokensQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ExploreTokensQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ExploreTokensQuery>(ExploreTokensDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'exploreTokens', 'query');
    },
    ...
    nftCount(variables: NftCountQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<NftCountQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<NftCountQuery>(NftCountDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'nftCount', 'query');
    },
    ...
    proposalsWithCalldata(variables: ProposalsWithCalldataQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<ProposalsWithCalldataQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<ProposalsWithCalldataQuery>(ProposalsWithCalldataDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'proposalsWithCalldata', 'query');
    },
    salesVolume(variables: SalesVolumeQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<SalesVolumeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SalesVolumeQuery>(SalesVolumeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'salesVolume', 'query');
    },
    ...
    tokenOwners(variables: TokenOwnersQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<TokenOwnersQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<TokenOwnersQuery>(TokenOwnersDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'tokenOwners', 'query');
    },
