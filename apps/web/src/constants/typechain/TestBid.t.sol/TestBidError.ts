...
export interface TestBidErrorInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "testBidIssue()": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "testBidIssue"
  ): FunctionFragment;
...
export interface TestBidError extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestBidErrorInterface;
  ...
  callStatic: {
    ...
    testBidIssue(overrides?: CallOverrides): Promise<void>;
  };
