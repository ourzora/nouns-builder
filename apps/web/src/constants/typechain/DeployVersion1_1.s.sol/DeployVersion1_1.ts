...
export interface DeployVersion1_1Interface extends utils.Interface {
  functions: {
...
export interface DeployVersion1_1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployVersion1_1Interface;
