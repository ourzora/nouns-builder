...
export interface TestUpdateMintersInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "testUpdateMinters()": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "IS_TEST" | "failed" | "setUp" | "testUpdateMinters"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testUpdateMinters",
    values?: undefined
  ): string;
...
export interface TestUpdateMinters extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestUpdateMintersInterface;
  ...
  callStatic: {
    ...
    testUpdateMinters(overrides?: CallOverrides): Promise<void>;
  };
