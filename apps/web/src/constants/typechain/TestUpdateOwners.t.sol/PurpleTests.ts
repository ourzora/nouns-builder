...
export interface PurpleTestsInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "failed()": FunctionFragment;
    "setUp()": FunctionFragment;
    "test_purpleUpgrade()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "test_purpleUpgrade",
    values?: undefined
  ): string;
...
export interface PurpleTests extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PurpleTestsInterface;
  ...
  callStatic: {
    ...
    test_purpleUpgrade(overrides?: CallOverrides): Promise<void>;
  };
