...
export interface DeployMetadataUpgradeInterface extends utils.Interface {
  functions: {
...
export interface DeployMetadataUpgrade extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployMetadataUpgradeInterface;
