...
export interface MockPartialTokenImplInterface extends utils.Interface {
  functions: {
...
export interface MockPartialTokenImpl extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockPartialTokenImplInterface;
